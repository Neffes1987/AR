...
export const MSETT_VIEW =  React.createClass({
    ...
    componentWillMount() {
        this.props.getRemoteData('REMOTE_MAIN_SETTING');
    }
})
...
const MSETT = connect(mapStateToProps, action_creator)(MSETT_VIEW);
export default MSETT
