...
export default React.createClass({
    ...
    componentWillMount() {
        const id = this.props.newEvent?this.props.newEvent:{};
        this.props.getRemoteData('REMOTE_EVENTS_ITEM',id);
    },
    render(){
                    ...
                    <tbody>
                        {actionsList.map((value,idx)=>{
                            ...
                            <tr key={idx}>
                                ...
                                <td>
                                    latitude: {actions[value].gps.lat}<br/>
                                    longitude: {actions[value].gps.lut}
                                </td>
