...
export default React.createClass({
    ...
    componentWillMount(){
        const id =this.props.newActions?this.props.newActions:0;
        this.props.getRemoteData('REMOTE_ACTIONS_ITEM',id);
    },
    render(){
        ...
        const models = gallary.map((value)=>{return {label:value.name,value:value.id}});
        let	  lutArr = [];
        let	  punishArr = [];
        let	  actionTypesArr = [];
        ...
        return(
            <div className='newAction'>
                ...
                <h5>Место действия:</h5>
                <ItemGroup label='Широта' iValue={gps.lat} placeholder='Широта.....' func={actionInputChange.bind(null,['list',id,'gps'])}/>
                <ItemGroup label='Долгота' iValue={gps.lut} placeholder='Долгота.....' func={actionInputChange.bind(null,['list',id,'gps'])}/>
                ...
                <Panel title='Условие успеха'>
                    ...
                    {lut.map((value)=>{
                        return (<ItemGroup
                            ...
                            disabled
                            button='Убрать'
                            buttonClick={actionArrayChange.bind(null,['list',id,'success','lut'],'delete',value)}
                            />)
                        })}
